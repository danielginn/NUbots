...
inline int FastHessian::isExtremum(int c, std::vector<ResponseLayer>::iterator t, std::vector<ResponseLayer>::iterator m, std::vector<ResponseLayer>::iterator b)
{
  // bounds check
...
inline void FastHessian::saveExtremum(int c, std::vector<ResponseLayer>::iterator t, std::vector<ResponseLayer>::iterator m, std::vector<ResponseLayer>::iterator b)
{
