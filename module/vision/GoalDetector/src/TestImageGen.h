...
std::vector<uint8_t> testImageGen(uint8_t imageNum, std::unique_ptr<message::localisation::Self>& self, double *d,int awayImages) {
	vector<double> d_values;
	string folder;
	if (awayImages == 0) {// check image d values (HOME)
		d_values = {20.0,15.0,12.0,12.0,15.0,15.0,15.0,15.0,15.0,20.0,15.0,10.0,10.0,10.0,12.0,7.0,5.0,10.0,7.0,76.0,73.0,71.0,68.0,68.0,71.0,77.0,72.0,72.0,67.0,69.0,69.0,70.0,69.0};
		folder = "/home/vagrant/NUbots/module/vision/GoalDetector/data/check";
	}
	else {// test image d values (AWAY)
		d_values = {30.0,28.0,12.0,9.0,5.0,10.0,10.0,30.0,40.0,33.0,30.0,30.0,25.0,26.0,25.0,33.0,25.0,38.0,43.0,37.0,35.0,36.0,44.0,38.0,38.0,46.0,45.0,37.0,37.0,34.0,33.0,36.0,33.0};
