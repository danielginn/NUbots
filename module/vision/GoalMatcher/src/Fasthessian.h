...
class FastHessian {
  ...
  private:
    ...
    //! 3x3 Extrema test
    inline int isExtremum(int c, std::vector<ResponseLayer>::iterator t, std::vector<ResponseLayer>::iterator m, std::vector<ResponseLayer>::iterator b);    

    //! Save function
    inline void saveExtremum(int c, std::vector<ResponseLayer>::iterator t, std::vector<ResponseLayer>::iterator m, std::vector<ResponseLayer>::iterator b);
