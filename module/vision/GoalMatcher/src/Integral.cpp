...
void getGrayHorizon(std::unique_ptr<std::vector<float>>& result, const message::vision::ClassifiedImage<message::vision::ObjectClass>& frame_4, int left_horizon, int right_horizon)
{
...
void Integral(std::unique_ptr<std::vector<float>>& data, const message::vision::ClassifiedImage<message::vision::ObjectClass>& frame_3, int left_horizon, int right_horizon)
{
